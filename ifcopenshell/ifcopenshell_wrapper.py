...
class tree(_object):
    ...
    def __init__(self, *args):
        ...
        __init__(IfcGeom::tree self, iterator_double_precision it) -> tree
        """
    ...
    def add_file(self, *args):
        ...
        add_file(tree self, iterator_double_precision it)
        """
        return _ifcopenshell_wrapper.tree_add_file(self, *args)


    def add_element(self, elem):
        """add_element(tree self, IfcGeom::BRepElement< double,double > * elem)"""
    ...
    def select(self, *args):
        """
        select(tree self, entity_instance e, bool completely_within=False, double extend=0.0) -> IfcEntityList::ptr
        ...
        select(tree self, gp_Pnt const & p, double extend=0.0) -> IfcEntityList::ptr
        select(tree self, gp_Pnt const & p) -> IfcEntityList::ptr
        select(tree self, std::string const & shape_serialization, bool completely_within=False, double extend=-1.e-5) -> IfcEntityList::ptr
        select(tree self, std::string const & shape_serialization, bool completely_within=False) -> IfcEntityList::ptr
...
class file(_object):
    ...
    def traverse_breadth_first(self, instance, max_level=-1):
        """
        traverse_breadth_first(file self, entity_instance instance, int max_level=-1) -> IfcEntityList::ptr
        traverse_breadth_first(file self, entity_instance instance) -> IfcEntityList::ptr
        """
